> 本文引自[Nginx开启Gzip压缩大幅提高页面加载速度](http://www.veryhuo.com/a/view/51706.html)
...
第6行：进行压缩的文件类型，缺啥补啥就行了，[**Java**](http://www.veryhuo.com/z/javaxz/)Script有两种写法，最好都写上吧，总有人抱怨js文件没有压缩，其实多写一种格式就行了
